...
2. Before we begin we need to get some seeds from the chest and place them in the Agents slot 1.

![alt text](https://advancedpython.codingcredentials.com/Lesson4/4.3.2/images/1.jpg?raw=true "Test")

3. Open the chat and run the farm command

![alt text](https://advancedpython.codingcredentials.com/Lesson4/4.3.2/images/2.jpg?raw=true "Test")

4. Your agent should till the land and place seeds on all the grass blocks. Now you will get an error when the agent tries to place seeds on the wood blocks - ignore these at the minute as we will look at how we
